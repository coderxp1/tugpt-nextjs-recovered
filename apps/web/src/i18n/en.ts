...
export const en: Dictionary = {
  ...
  // Analytics v1 — usage and cost. Unknown totals are said to be unknown; a
  // zero is never shown where a price is missing.
  'analytics.title': 'Usage & cost',
  'analytics.loading': 'Loading usage…',
  'analytics.loadFailed': 'Could not load the usage',
  ...
  'analytics.empty': 'No usage recorded in this period.',
  'analytics.totalsTitle': 'Period summary',
  'analytics.events': 'Recorded calls',
  'analytics.pricedEvents': 'Priced',
  'analytics.unpricedEvents': 'Unpriced',
  'analytics.unpricedNotice':
    '{count} calls have no price: their cost is unknown and is not counted as zero.',
  'analytics.unconvertedNotice':
    '{count} priced calls could not be converted to the accounting currency; their cost is missing from the converted total.',
  'analytics.accountingCost': 'Converted cost ({currency})',
  'analytics.nativeCost': 'Billed cost ({currency})',
  'analytics.costUnknown': 'Cost unknown',
  'analytics.quantities.input_tokens': 'Input tokens',
  'analytics.quantities.output_tokens': 'Output tokens',
  'analytics.quantities.audio_seconds': 'Billed audio seconds',
  'analytics.byProviderTitle': 'By provider and model',
  'analytics.provider': 'Provider',
  'analytics.model': 'Model',
  'analytics.modality': 'Modality',
  'analytics.modality.text': 'Text',
  'analytics.modality.audio': 'Audio',
  'analytics.modelUnknown': 'Not specified',
  'analytics.column.events': 'Calls',
  'analytics.column.cost': 'Cost',
  'analytics.unpricedShort': '{count} unpriced',
  ...
  'errors.INVALID_QUERY': 'The query parameters are not valid',
  'errors.QUERY_WINDOW_TOO_LARGE': 'The requested time window is too large',
